...
"C:\Program Files (x86)\Revision Tool\unins000.exe" /silent

for /D %%X in (C:\Users\*) do (
    attrib +h "%%X\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Administrative Tools.lnk"
)

del "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Accessibility\Speech Recognition.lnk"

for /D %%X in (C:\Users\*) do (
    attrib +h "%%X\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Accessibility\*" /s /d
)
...
powercfg -changename 3ff9831b-6f80-4830-8178-736cd4229e7b "Light - Ultra Performance" "Windows's Ultimate Performance with additional changes." >NUL 2>nul
...
del "%USERPROFILE%\Desktop\Revision Tool.lnk"
